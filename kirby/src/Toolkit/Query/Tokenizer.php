...
class Tokenizer {
    ...
    protected static function scanToken(string $source, int $current): Token {
        ...
        return match(true) {
            ...
            self::match($source, $current, 'true', $l, true) => new Token(TokenType::TRUE, $l),
            self::match($source, $current, 'false', $l, true) => new Token(TokenType::FALSE, $l),
            self::match($source, $current, 'null', $l, true) => new Token(TokenType::NULL, $l),
